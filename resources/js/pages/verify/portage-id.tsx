...
import { OPERATOR_MAP, computeMd5 } from '@/lib/pnm-utils';
import type { BreadcrumbItem } from '@/types';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'Vérifier', href: '/verify' },
    { title: 'ID portage (MD5)', href: '/verify/portage-id' },
];

const operators = Object.entries(OPERATOR_MAP).map(([code, name]) => ({
    code,
    name,
}));
            ...
            >
                <Box>
                    <Typography variant="h5" fontWeight={700}>
                        Calculateur d'ID portage
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                        Générez le hash MD5 d'identification de portage :
                        MD5(OPR + OPD + DateSouscription + MSISDN).
                    </Typography>
                </Box>
                ...
                {hash && (
                    <>
                        ...
                        <Alert severity="info">
                            Le hash est calculé entièrement côté client — aucune
                            donnée n'est envoyée au serveur.
                        </Alert>
                    </>
                )}
            </Box>
