...
import { type MsisdnResult, checkMsisdn } from '@/lib/pnm-utils';
import type { BreadcrumbItem } from '@/types';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'Vérifier', href: '/verify' },
    { title: 'Vérificateur MSISDN', href: '/verify/msisdn-checker' },
];
            ...
            >
                <Box>
                    <Typography variant="h5" fontWeight={700}>
                        Vérificateur de MSISDN
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                        Vérifiez un numéro mobile Antilles-Guyane : format,
                        opérateur et zone géographique.
                    </Typography>
                </Box>
