    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <Box component="header" sx={{ mb: 3, width: '100%', maxWidth: 896, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
                    {auth.user ? (
                        <Button component={Link} href={dashboard().url} variant="outlined" size="small">
                            Dashboard
                        </Button>
                    ) : (
                        <>
                            <Button component={Link} href={login().url} size="small">
                                Log in
                            </Button>
                            {canRegister && (
                                <Button component={Link} href={register().url} variant="outlined" size="small">
                                    Register
                                </Button>
                            )}
                        </>
