...
| [operations/points-hebdo.md](operations/points-hebdo.md) | **Points hebdomadaires** (Fred + Benoît) — aide-mémoire oral tous domaines (PNM, MOBI/CRM, tickets, outillage), sujets ouverts et historique par semaine — *document vivant* |
