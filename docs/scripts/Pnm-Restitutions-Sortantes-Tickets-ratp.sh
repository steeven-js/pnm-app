...
# working files
soapRequestFile=~/Resultats/CreatePortaRestitution_Request-ratp.xml
mobi_extract_restitutions_sortantes_sql=~/Sql/MOBI-Extract-Restitutions_Sortantes-ratp.sql
mobi_extract_restitutions_sortantes_resultat=~/Resultats/MOBI_Extract_Restitutions-ratp.txt
